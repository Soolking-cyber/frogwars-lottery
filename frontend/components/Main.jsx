  ...
  return (
    <div className="min-h-screen bg-black ">
      ...
      <main>
        ...
        <a href="https://www.nile.build/swap?to=0x21d624c846725ABe1e1e7d662E9fB274999009Aa" type="button" className="w-40 h-10 px-4 py-2 mt-12 mb-2 text-sm font-medium text-white bg-purple-600 rounded-md cursor-pointer focus:outline-none hover:bg-purple-700 focus:ring-4 focus:ring-purple-300 font-customFont dark:bg-purple-600 dark:hover:bg-purple-700 dark:focus:ring-purple-900">Get Crystals</a>
      </main>
    </div>
  );
}
